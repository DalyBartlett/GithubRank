...
//        versionLabel.text = "\(K.appVersion)"
    ...
    let indexPathSelectors = [
        "section1row0" : "developerTwitter",
        "section1row1" : "developerGithub",
    ]
...
//        let _ = Twitter.Follow(username: K.twitterHandle)
        let _ = Twitter.Follow(username: "TimothyHugh")
    }
    
    func developerGithub() {
        
        Browser.openPage("https://github.com/DalyBartlett/GithubRank")
